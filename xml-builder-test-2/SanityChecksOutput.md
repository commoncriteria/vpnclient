...
* Error: Detected multiple elements with an id of 'at-impl-dep'.
* Error: Detected multiple elements with an id of 'fau'.
* Error: Detected dangling ref to 'T.UNAUTHORIZED_ACCESS'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[1]""/con-mod[1]"The threa"/ref[1]""
* Error: Detected dangling ref to 'T.TSF_CONFIGURATION'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[1]""/con-mod[2]"The threa"/ref[1]""
* Error: Detected dangling ref to 'T.USER_DATA_REUSE'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[1]""/con-mod[3]"Inadverte"/ref[1]""
* Error: Detected dangling ref to 'T.TSF_FAILURE'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[1]""/con-mod[4]"A failure"/ref[1]""
...
* Error: Detected dangling ref to 'T.UNAUTHORIZED_ACCESS'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[2]""/con-mod[1]"The threa"/ref[1]""
* Error: Detected dangling ref to 'T.TSF_CONFIGURATION'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[2]""/con-mod[2]"The threa"/ref[1]""
* Error: Detected dangling ref to 'T.USER_DATA_REUSE'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[2]""/con-mod[3]"Inadverte"/ref[1]""
* Error: Detected dangling ref to 'T.TSF_FAILURE'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[2]""/con-mod[4]"A failure"/ref[1]""
...
* Error: Detected dangling ref to 'T.UNAUTHORIZED_ACCESS'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[3]""/con-mod[1]"The threa"/ref[1]""
* Error: Detected dangling ref to 'T.TSF_CONFIGURATION'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[3]""/con-mod[2]"The threa"/ref[1]""
* Error: Detected dangling ref to 'T.USER_DATA_REUSE'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[3]""/con-mod[3]"Inadverte"/ref[1]""
* Error: Detected dangling ref to 'T.TSF_FAILURE'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[3]""/con-mod[4]"A failure"/ref[1]""
...
* Error: Detected dangling ref to 'T.UNAUTHORIZED_ACCESS'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[4]""/con-mod[1]"The threa"/ref[1]""
* Error: Detected dangling ref to 'T.TSF_CONFIGURATION'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[4]""/con-mod[2]"The threa"/ref[1]""
* Error: Detected dangling ref to 'T.USER_DATA_REUSE'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[4]""/con-mod[3]"Inadverte"/ref[1]""
* Error: Detected dangling ref to 'T.TSF_FAILURE'
        for a ref.
	/Module[1]""/sec:Security_Requirements[1]""/base-pp[4]""/con-mod[4]"A failure"/ref[1]""
...
* Warning: Detected an empty _p_ element./Module[1]""/sec:Security_Requirements[1]""/base-pp[4]""/modified-sfrs[1]""/section[2]""/base-sfr-spec[1]""/description[1]""/h:p[1]"When the "/h:p[1]""
* Warning: Detected an empty _p_ element./Module[1]""/sec:Security_Requirements[1]""/base-pp[4]""/modified-sfrs[1]""/section[2]""/base-sfr-spec[2]""/description[1]""/h:p[1]"When the "/h:p[1]""
